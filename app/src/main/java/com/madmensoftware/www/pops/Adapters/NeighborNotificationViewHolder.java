 ...
 */
public class NeighborNotificationViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public NeighborNotificationViewHolder(View itemView) {
        super(itemView);
        mView = itemView;
    ...
    public void onClick(View view) {
        ...
        Query jobQuery = FirebaseDatabase.getInstance().getReference().child("jobs").orderByChild("cashPostNot").equalTo(FirebaseAuth.getInstance().getCurrentUser().getUid());
