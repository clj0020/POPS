 ...
 */
public class ParentJobViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ParentJobViewHolder(View itemView) {
        super(itemView);
        mView = itemView;
    ...
    public void onClick(View view) {
        ...
        Query jobQuery = FirebaseDatabase.getInstance().getReference().child("jobs").orderByChild("parentUid").equalTo(FirebaseAuth.getInstance().getCurrentUser().getUid());
